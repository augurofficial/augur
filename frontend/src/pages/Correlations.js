...
function Correlations({ indicatorData }) {
  ...
  const PAIR_CONTEXT = {
    'Polarization+Inst. Trust': 'When people lose trust in institutions, they retreat to partisan identity as their primary political framework. Declining institutional legitimacy may reduce the shared ground that facilitates compromise.',
    'Inst. Trust+Polarization': 'When people lose trust in institutions, they retreat to partisan identity as their primary political framework. Declining institutional legitimacy may reduce the shared ground that facilitates compromise.',
    'Debt/GDP+Wealth Ineq.': 'Government borrowing increasingly finances returns to asset holders (through bond interest and monetary policy) while costs are distributed across the tax base. Rising debt and rising wealth concentration have tended to reinforce each other in documented historical cases.',
    'Wealth Ineq.+Debt/GDP': 'Government borrowing increasingly finances returns to asset holders (through bond interest and monetary policy) while costs are distributed across the tax base. Rising debt and rising wealth concentration have tended to reinforce each other in documented historical cases.',
    'Media Trust+Polarization': 'When shared information sources fragment, people may sort into divergent factual frameworks. Reduced agreement on basic facts can make political compromise more difficult. Media fragmentation has accompanied several historical periods of rising polarization.',
    'Polarization+Media Trust': 'When shared information sources fragment, people may sort into divergent factual frameworks. Reduced agreement on basic facts can make political compromise more difficult. Media fragmentation has accompanied several historical periods of rising polarization.',
