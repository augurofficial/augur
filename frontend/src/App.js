  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        const ids = ['wealth_inequality','debt_to_gdp','currency_debasement','elite_overproduction','political_polarization','geopolitical_standing','middle_class_decline','infrastructure_decay'];
