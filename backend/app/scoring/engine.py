...
INDICATORS = {
    ...
    "unemployment": IndicatorSpec(
        ...
        norm_method="percentile_rank", norm_reference="oecd_historical",
        weight_justification="Equal weight. LAGGING — rises after structural problems manifest. Weight reduced to 0.7 to prevent single-indicator dominance (OECD threshold: no indicator >40% of variance).",
    ...
    "consumer_sentiment": IndicatorSpec(
        ...
        domain=TheoreticalDomain.AUGMENTED, direction="lower_is_worse",
        norm_method="percentile_rank", norm_reference="us_historical",
        weight_justification="Equal weight. LAGGING + AUGMENTED. Population stress thermometer. Weight reduced to 0.7 (lagging + augmented = lowest confidence).",
    ...
    "savings_rate": IndicatorSpec(
        ...
        domain=TheoreticalDomain.POPULATION, direction="lower_is_worse",
        norm_method="percentile_rank", norm_reference="us_historical",
        weight_justification="Equal weight. LAGGING — responds to conditions. Weight reduced to 0.7 to prevent lagging indicators from dominating the composite.",
